...
<div class="container my-5 p-5 bg-white shadow rounded">
   <div class="d-flex justify-content-between mb-4">
        ...
        <img src="http://localhost/form/img/logo2.jpg" class="img-solid" style="max-height: 90px;">

        <h6 class="text-center mb-4">REPUBLIC OF THE PHILIPPINES<br>CITY OF CEBU<br>DEPARTMENT OF SOCIAL WELFARE AND SERVICES</h6>

        <img src="http://localhost/form/img/logo3.png" class="img-solid" style="max-height: 70px;">
        <img src="http://localhost/form/img/logo4.jpg" class="img-solid" style="max-height: 70px;">
